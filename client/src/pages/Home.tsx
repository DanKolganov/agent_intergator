  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-900">
      ...
      <main className="flex-grow">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                ...
                <br className="hidden md:block" /> для вашего бизнеса.
              </motion.h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
                Выберите вашу сферу деятельности и найдите готовые
                AI-инструменты для решения конкретных задач
              </p>
            </motion.div>
              ...
              >
                <Link href="/agents?business=hospitality">
                  <div className="p-8 rounded-3xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300 cursor-pointer">
                    ...
                    <h3 className="text-xl font-bold font-display mb-3 text-slate-900 dark:text-slate-100">
                      Гостиничный бизнес
                    </h3>
              ...
              >
                <Link href="/agents?task=customers">
                  <div className="p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-primary/30 hover:shadow-md transition-all duration-300 cursor-pointer">
                    ...
                    <h3 className="text-lg font-bold font-display mb-2 text-slate-900 dark:text-slate-100">
                      Работа с клиентами
                    </h3>
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
                      Автоматизация общения, обработка обращений, управление
                      лояльностью
                    </p>
                  </div>
                </Link>
              ...
              >
                <Link href="/agents?task=finance">
                  <div className="p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-green-500/30 hover:shadow-md transition-all duration-300 cursor-pointer">
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
                      Финансовая аналитика, бюджетирование, налоговая
                      оптимизация
                    </p>
                  </div>
                </Link>
              ...
              >
                <Link href="/agents?task=hr">
                  <div className="p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-blue-500/30 hover:shadow-md transition-all duration-300 cursor-pointer">
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
                      Адаптация сотрудников, обучение, управление кадровыми
                      документами
                    </p>
                  </div>
                </Link>
              ...
              >
                <Link href="/agents?task=operations">
                  <div className="p-6 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-orange-500/30 hover:shadow-md transition-all duration-300 cursor-pointer">
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
                      Автоматизация процессов, управление документами,
        ...
        {/* Features / Value Prop */}
        <section className="py-24 bg-white dark:bg-slate-800 border-y border-slate-100 dark:border-slate-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-3 gap-12">
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-700 border border-slate-100 dark:border-slate-600 hover:border-primary/20 transition-colors"
              >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.1 }}
                className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-700 border border-slate-100 dark:border-slate-600 hover:border-accent/20 transition-colors"
              >
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                  Не нашли подходящее? Система анализирует ваши потребности и
                  предлагает архитектуру кастомного агента.
                </p>
              </motion.div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.2 }}
                className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-700 border border-slate-100 dark:border-slate-600 hover:border-pink-500/20 transition-colors"
              >
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                  Без месяцев разработки: интеграция с вашими процессами — за
                  минуты, а не за месяцы.
                </p>
              </motion.div>
            </div>
          </div>
